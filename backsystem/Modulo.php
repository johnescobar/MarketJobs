...
$array_valida = array(  
	 "Nombre" => "Nombre" , "Directorio" => "Directorio" 	
); 
...
<tr>
			...
			<tr>
			<td  class="columnafija" > Directorio </td><td><input id=Directorio type=text size=25  name=Directorio class="input mandatory " title="Directorio" value="<?=$frm[Directorio] ?>"> </td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->Nombre ?></td> <td nowrap><? echo $r->Directorio ?></td> 
