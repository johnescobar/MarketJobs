...
SIMReg::setFromStructure( array(
					"title" => "CandidatoDocumento",
					"table" => "CandidatoDocumento",
					"key" => "IDDocumento",
					"mod" => "CandidatoDocumento"
) );


//para validar los campos del formulario
$array_valida = array(  
	 "IDDocumento" => "IDDocumento" , "IDCandidato" => "IDCandidato" , "IDOferta" => "IDOferta" , "Nombre" => "Nombre" , "Comentario" => "Comentario" , "File" => "File" 	
); 
...
<tr>
			<td  class="columnafija" > IDDocumento </td><td><input id=IDDocumento type=text size=25 readonly name=IDDocumento class="input mandatory " title="IDDocumento" value="<?=$frm[IDDocumento] ?>"> </td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDDocumento ?></td> <td nowrap><? echo $r->IDCandidato ?></td> <td nowrap><? echo $r->IDOferta ?></td> <td nowrap><? echo $r->Nombre ?></td> <td nowrap><? echo $r->Comentario ?></td> <td nowrap><? echo $r->File ?></td> 
