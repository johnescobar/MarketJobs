...
SIMReg::setFromStructure( array(
					"title" => "CandidatoPosgrado",
					"table" => "CandidatoPosgrado",
					"key" => "IDCandidato",
					"mod" => "CandidatoPosgrado"
) );


//para validar los campos del formulario
$array_valida = array(  
	 "IDCandidato" => "IDCandidato" , "IDPosgrado" => "IDPosgrado" , "Universidad" => "Universidad" , "Carrera" => "Carrera" , "FechaFin" => "FechaFin" 	
); 
...
<tr>
			...
			<tr>
			<td  class="columnafija" > IDPosgrado </td><td><input id=IDPosgrado type=text size=25  name=IDPosgrado class="input mandatory " title="IDPosgrado" value="<?=$frm[IDPosgrado] ?>"> </td>
			</tr>
			<tr>
			<td  class="columnafija" > Universidad </td><td><input id=Universidad type=text size=25  name=Universidad class="input mandatory " title="Universidad" value="<?=$frm[Universidad] ?>"> </td>
			</tr>
			<tr>
			<td  class="columnafija" > Carrera </td><td><textarea rows="5" id=Carrera cols=60 wrap=virtual class="input mandatory" title="Carrera" name=Carrera><?=$frm[Carrera]?></textarea></td>
			</tr>
			<tr>
			<td  class="columnafija" > FechaFin </td><td><input id=FechaFin type=text size=10 readonly name=FechaFin class="input mandatory  calendar " title="FechaFin" value="<?=$frm[FechaFin] ?>"> </td>
			</tr>
			<tr>
...
<tr>
					<td class=texto colspan=8  ><?php echo $result["info"]?></td>
...
<td nowrap><? echo $r->IDCandidato ?></td> <td nowrap><? echo $r->IDPosgrado ?></td> <td nowrap><? echo $r->Universidad ?></td> <td nowrap><? echo $r->Carrera ?></td> <td nowrap><? echo $r->FechaFin ?></td> 
<td align=center width=64 ><a href='<? echo "?mod=" . $mod . "&amp;action=del&amp;id=" . $r->$key?>'><img src='images/trash.png' border='0'></a></td></tr>
<? } // END for
?>
<tr>
					<th class=texto colspan=8 nowrap  ><?php echo $result["pages"]?></th>
