...
$array_valida = array(  
	 "IDIdioma" => "IDIdioma" , "IDCandidato" => "IDCandidato" , "Lee" => "Lee" , "Habla" => "Habla" , "Escribe" => "Escribe" 	
); 
...
<tr>
			<td  class="columnafija" > IDIdioma </td><td><input id=IDIdioma type=text size=25 readonly name=IDIdioma class="input mandatory " title="IDIdioma" value="<?=$frm[IDIdioma] ?>"> </td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDIdioma ?></td> <td nowrap><? echo $r->IDCandidato ?></td> <td nowrap><? echo $r->Lee ?></td> <td nowrap><? echo $r->Habla ?></td> <td nowrap><? echo $r->Escribe ?></td> 
