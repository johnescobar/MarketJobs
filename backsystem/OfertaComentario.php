...
SIMReg::setFromStructure( array(
					"title" => "OfertaComentario",
					"table" => "OfertaComentario",
					"key" => "IDComentario",
					"mod" => "OfertaComentario"
) );


//para validar los campos del formulario
$array_valida = array(  
	 "IDComentario" => "IDComentario" , "IDOferta" => "IDOferta" , "From" => "From" , "To" => "To" , "Comentario" => "Comentario" , "SolicitudProceso" => "SolicitudProceso" 	
); 
...
<tr>
			...
			<tr>
			<td  class="columnafija" > SolicitudProceso </td><td><? echo SIMHTML::formradiogroup( array_flip( SIMResources::$sino ) , $frm["SolicitudProceso"] , 'SolicitudProceso' , "class=' mandatory'" ) ?></td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDComentario ?></td> <td nowrap><? echo $r->IDOferta ?></td> <td nowrap><? echo $r->From ?></td> <td nowrap><? echo $r->To ?></td> <td nowrap><? echo $r->Comentario ?></td> <td nowrap><? echo $r->SolicitudProceso ?></td> 
