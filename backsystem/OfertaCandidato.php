...
SIMReg::setFromStructure( array(
					"title" => "OfertaCandidato",
					"table" => "OfertaCandidato",
					"key" => "IDCandidato",
					"mod" => "OfertaCandidato"
) );
...
$array_valida = array(  
	 "IDCandidato" => "IDCandidato" , "IDOferta" => "IDOferta" , "AceptaCandidato" => "AceptaCandidato" , "FechaAceptacion" => "FechaAceptacion" , "Seleccionado" => "Seleccionado" , "FechaSeleccion" => "FechaSeleccion" , "Publicar" => "Publicar" 	
); 
...
<tr>
			<td  class="columnafija" > IDCandidato </td><td><input id=IDCandidato type=text size=25 readonly name=IDCandidato class="input mandatory " title="IDCandidato" value="<?=$frm[IDCandidato] ?>"> </td>
			</tr>
			<tr>
			...
			<tr>
			<td  class="columnafija" > AceptaCandidato </td><td><input id=AceptaCandidato type=text size=25  name=AceptaCandidato class="input mandatory " title="AceptaCandidato" value="<?=$frm[AceptaCandidato] ?>"> </td>
			</tr>
			<tr>
			<td  class="columnafija" > FechaAceptacion </td><td><input id=FechaAceptacion type=text size=10 readonly name=FechaAceptacion class="input mandatory  calendar " title="FechaAceptacion" value="<?=$frm[FechaAceptacion] ?>"> </td>
			</tr>
			<tr>
			<td  class="columnafija" > Seleccionado </td><td><? echo SIMHTML::formradiogroup( array_flip( SIMResources::$sino ) , $frm["Seleccionado"] , 'Seleccionado' , "class=' mandatory'" ) ?></td>
			</tr>
			<tr>
			<td  class="columnafija" > FechaSeleccion </td><td><input id=FechaSeleccion type=text size=10 readonly name=FechaSeleccion class="input mandatory  calendar " title="FechaSeleccion" value="<?=$frm[FechaSeleccion] ?>"> </td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDCandidato ?></td> <td nowrap><? echo $r->IDOferta ?></td> <td nowrap><? echo $r->AceptaCandidato ?></td> <td nowrap><? echo $r->FechaAceptacion ?></td> <td nowrap><? echo $r->Seleccionado ?></td> <td nowrap><? echo $r->FechaSeleccion ?></td> <td nowrap><? echo $r->Publicar ?></td> 
