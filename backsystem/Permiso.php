...
$array_valida = array(  
	 "IDPerfil" => "IDPerfil" , "IDModulo" => "IDModulo" , "Permiso" => "Permiso" 	
); 
...
<tr>
			<td  class="columnafija" > IDPerfil </td><td><input id=IDPerfil type=text size=25  name=IDPerfil class="input mandatory " title="IDPerfil" value="<?=$frm[IDPerfil] ?>"> </td>
			</tr>
			<tr>
			<td  class="columnafija" > IDModulo </td><td><input id=IDModulo type=text size=25  name=IDModulo class="input mandatory " title="IDModulo" value="<?=$frm[IDModulo] ?>"> </td>
			</tr>
			<tr>
			<td  class="columnafija" > Permiso </td><td><input id=Permiso type=text size=25  name=Permiso class="input mandatory " title="Permiso" value="<?=$frm[Permiso] ?>"> </td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDPerfil ?></td> <td nowrap><? echo $r->IDModulo ?></td> <td nowrap><? echo $r->Permiso ?></td> 
