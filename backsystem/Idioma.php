...
<tr>
			<td  class="columnafija" > Nombre </td><td><textarea rows="5" id=Nombre cols=60 wrap=virtual class="input mandatory" title="Nombre" name=Nombre><?=$frm[Nombre]?></textarea></td>
			</tr>
			<tr>
