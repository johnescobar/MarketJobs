...
SIMReg::setFromStructure( array(
					"title" => "OfertaPosgrado",
					"table" => "OfertaPosgrado",
					"key" => "IDOferta",
					"mod" => "OfertaPosgrado"
) );
...
$array_valida = array(  
	 "IDOferta" => "IDOferta" , "IDPosgrado" => "IDPosgrado" , "Carrera" => "Carrera" , "FechaFin" => "FechaFin" 	
); 
...
<td nowrap><? echo $r->IDOferta ?></td> <td nowrap><? echo $r->IDPosgrado ?></td> <td nowrap><? echo $r->Carrera ?></td> <td nowrap><? echo $r->FechaFin ?></td> 
