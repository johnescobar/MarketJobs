...
SIMReg::setFromStructure( array(
					"title" => "OfertaPregrado",
					"table" => "OfertaPregrado",
					"key" => "IDPregrado",
					"mod" => "OfertaPregrado"
) );
...
$array_valida = array(  
	 "IDPregrado" => "IDPregrado" , "IDOferta" => "IDOferta" , "Carrera" => "Carrera" , "FechaFin" => "FechaFin" 	
); 
...
<tr>
					<td class=texto colspan=7  ><?php echo $result["info"]?></td>
...
<td nowrap><? echo $r->IDPregrado ?></td> <td nowrap><? echo $r->IDOferta ?></td> <td nowrap><? echo $r->Carrera ?></td> <td nowrap><? echo $r->FechaFin ?></td> 
