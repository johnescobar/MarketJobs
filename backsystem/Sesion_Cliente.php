...
SIMReg::setFromStructure( array(
					"title" => "Sesion_Cliente",
					"table" => "Sesion_Cliente",
					"key" => "IDSesion",
					"mod" => "Sesion_Cliente"
) );
...
$array_valida = array(  
	 "IDSesion" => "IDSesion" , "IDUsuario" => "IDUsuario" , "Inicio" => "Inicio" , "Datos" => "Datos" 	
); 
...
<tr>
			<td  class="columnafija" > IDSesion </td><td><input id=IDSesion type=text size=25 readonly name=IDSesion class="input mandatory " title="IDSesion" value="<?=$frm[IDSesion] ?>"> </td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDSesion ?></td> <td nowrap><? echo $r->IDUsuario ?></td> <td nowrap><? echo $r->Inicio ?></td> <td nowrap><? echo $r->Datos ?></td> 
