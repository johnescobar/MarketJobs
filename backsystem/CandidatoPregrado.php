...
SIMReg::setFromStructure( array(
					"title" => "CandidatoPregrado",
					"table" => "CandidatoPregrado",
					"key" => "IDPregrado",
					"mod" => "CandidatoPregrado"
) );


//para validar los campos del formulario
$array_valida = array(  
	 "IDPregrado" => "IDPregrado" , "IDCandidato" => "IDCandidato" , "Universidad" => "Universidad" , "Carrera" => "Carrera" , "FechaFin" => "FechaFin" 	
); 
...
<tr>
			<td  class="columnafija" > IDPregrado </td><td><input id=IDPregrado type=text size=25 readonly name=IDPregrado class="input mandatory " title="IDPregrado" value="<?=$frm[IDPregrado] ?>"> </td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDPregrado ?></td> <td nowrap><? echo $r->IDCandidato ?></td> <td nowrap><? echo $r->Universidad ?></td> <td nowrap><? echo $r->Carrera ?></td> <td nowrap><? echo $r->FechaFin ?></td> 
