...
$array_valida = array(  
	 "IDNoticia" => "IDNoticia" , "Nombre" => "Nombre" , "Descripcion" => "Descripcion" , "Foto" => "Foto" 	
); 
...
<tr>
			<td  class="columnafija" > IDNoticia </td><td><input id=IDNoticia type=text size=25  name=IDNoticia class="input mandatory " title="IDNoticia" value="<?=$frm[IDNoticia] ?>"> </td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDNoticia ?></td> <td nowrap><? echo $r->Nombre ?></td> <td nowrap><? echo $r->Descripcion ?></td> <td nowrap><? echo $r->Foto ?></td> 
