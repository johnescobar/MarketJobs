...
$array_valida = array(  
	 "IDUsuario" => "IDUsuario" , "Descripcion" => "Descripcion" , "Leido" => "Leido" , "URL" => "URL" 	
); 
...
<tr>
			...
			<tr>
			<td  class="columnafija" > Leido </td><td><? echo SIMHTML::formradiogroup( array_flip( SIMResources::$sino ) , $frm["Leido"] , 'Leido' , "class=' mandatory'" ) ?></td>
			</tr>
			<tr>
			<td  class="columnafija" > URL </td><td><textarea rows="5" id=URL cols=60 wrap=virtual class="input mandatory" title="URL" name=URL><?=$frm[URL]?></textarea></td>
			</tr>
			<tr>
...
<td nowrap><? echo $r->IDUsuario ?></td> <td nowrap><? echo $r->Descripcion ?></td> <td nowrap><? echo $r->Leido ?></td> <td nowrap><? echo $r->URL ?></td> 
