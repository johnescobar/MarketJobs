...
$array_valida = array(  
	 "IDDepartamento" => "IDDepartamento" , "Nombre" => "Nombre" 	
); 
...
function print_form( $frm = "" , $newmode , $submit_caption )
{
	...
	if( $newmode == "update" )
	{
		$frm["IDPais"] = $dbo->getFields("Departamento","IDPais","IDDepartamento = '" . $frm["IDDepartamento"] . "' ");
	}//end if
...
<td nowrap><? echo $dbo->getFields("Departamento", "Nombre", "IDDepartamento = '" . $r->IDDepartamento . "' ") ?></td> <td nowrap><? echo $r->Nombre ?></td> 
