...
<tr>
			<td  class="columnafija" > Path </td><td><textarea rows="5" id=Path cols=60 wrap=virtual class="input mandatory" title="Path" name=Path><?=$frm[Path]?></textarea></td>
			</tr>
			<tr>
			<td  class="columnafija" > IDUsuario </td><td><input id=IDUsuario type=text size=25 readonly name=IDUsuario class="input mandatory " title="IDUsuario" value="<?=$frm[IDUsuario] ?>"> </td>
			</tr>
			<tr>
...
<table width=100%  cellpadding=0 cellspacing=0 align=center>
	...
	<tr>
					<th class=title colspan=5   ><?php echo strtoupper( SIMReg::get( "title" ) ) . ": Listado"?></th>
...
<td nowrap><? echo $r->Path ?></td> <td nowrap><? echo $r->IDUsuario ?></td> 
